class Form {
    ...
    constructor() 
    {
        ...
        this.text = createElement('h1', "Ready for some amazing questions?");
        ...
        this.question2 = createElement('h3', "Q2. Would you be willing to contribute a small amount every month for amazing programs ?");
